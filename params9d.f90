...
module params
	...
	real(dp), parameter :: dt =2e-5_dp
	real(dp), parameter :: t_0=0._dp
	real(dp), parameter :: t_f=2000._dp
	...
	integer, parameter :: dims=9
	integer, parameter :: coeff_num =31

	!array like params, the initial condition and the forcing vector
	real(dp), parameter, dimension(dims) :: &
	init_con =(/0.927796_dp,0.160574_dp,-0.0969953_dp,-0.672758_dp,-0.118184_dp,0.214505_dp,0.0_dp,0.0_dp,0.0_dp/)
	real(dp), parameter, dimension(dims) :: &
	xf=(/0.95_dp,0._dp,0._dp,-0.76095_dp,0._dp,0._dp,-0.5_dp,0._dp,0._dp/)
